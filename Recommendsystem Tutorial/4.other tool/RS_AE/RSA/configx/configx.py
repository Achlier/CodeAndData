...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        self.k_test = 0  # the num of test
        self.rating_path = "RSA/data/%s_ratings.txt" % self.dataset_name  # the raw ratings data file
        self.rating_cv_path = "RSA/data/cv/"  # the cross validation file of ratings data
        self.trust_path = 'RSA/data/%s_trust.txt' % self.dataset_name  # the raw trust data file
        ...
        self.maxIter = 3  # the maximum number of iterations
